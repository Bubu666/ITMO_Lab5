...
public class Main {
     ...
     * Также создается слушатель команд, вводимых пользователем с консоли {@code CommandListener}
     *
    ...
    /**
     * Метод проверяет файл на доступность и существование и выводит в консоль
