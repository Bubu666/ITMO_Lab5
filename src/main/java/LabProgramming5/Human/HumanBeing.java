...
public class HumanBeing implements Comparable<HumanBeing> {
    ...
    private static class HumanStorage {
        ...
        static {
            ...
            String filePath = HumanBeing.class.getProtectionDomain().getCodeSource().getLocation().getPath()
                    .split("lab5")[0] + "lab5" + sp + "initSources" + sp;

            File names = new File(filePath + "names");
            File soundtracks = new File(filePath + "soundTracks");
